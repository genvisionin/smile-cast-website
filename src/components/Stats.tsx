...
export function Stats() {
    return (
        <section className="w-full bg-page pt-16 pb-24 px-6 lg:px-8">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
                className="mx-auto max-w-[1024px] bg-white rounded-2xl shadow-[var(--shadow-sm)] p-8 lg:p-12"
            >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-neutral-200">

                    {/* STAT 1 */}
                    <div className="flex flex-col items-center md:items-start text-center md:text-left pt-6 pb-2 md:py-0 md:px-8 first:pt-0 first:pl-0 last:pr-0">
